...
class TenderStage2EULotAwardComplaintResourceTest(BaseCompetitiveDialogEUStage2ContentWebTest):
    ...
    def test_create_tender_complaint(self):
        ...
        response = self.app.patch_json('/tenders/{}/complaints/{}?acc_token={}'.format(self.tender_id, complaint['id'], self.tender_token),
                                       {"data": {"status": "answered"}}, status=422)
        self.assertEqual(response.status, '422 Unprocessable Entity')
        self.assertEqual(response.content_type, 'application/json')
        self.assertEqual(response.json['errors'], [
            {u'description': [u'This field is required.'], u'location': u'body', u'name': u'resolutionType'},
        ...
        self.assertEqual(response.content_type, 'application/json')
        self.assertEqual(response.json['errors'][0]["description"],
                         "Can't update complaint in current (resolved) status")
...
class TenderStage2EUComplaintDocumentResourceTest(BaseCompetitiveDialogEUStage2ContentWebTest):
    ...
    def test_not_found(self):
        response = self.app.post('/tenders/some_id/complaints/some_id/documents',
        ...
        response = self.app.post('/tenders/{}/complaints/some_id/documents?acc_token={}'.format(self.tender_id,
        ...
        response = self.app.get('/tenders/{}/complaints/{}/documents/some_id'.format(self.tender_id,
                                                                                     self.complaint_id),
                                status=404)
        self.assertEqual(response.status, '404 Not Found')
        self.assertEqual(response.content_type, 'application/json')
        ...
        response = self.app.put('/tenders/{}/complaints/some_id/documents/some_id'.format(self.tender_id),
        ...
        response = self.app.put('/tenders/{}/complaints/{}/documents/some_id'.format(self.tender_id,
                                                                                     self.complaint_id),
                                status=404,
                                upload_files=[('file', 'name.doc', 'content2')])
        self.assertEqual(response.status, '404 Not Found')
    ...
    def test_create_tender_complaint_document(self):
        ...
        response = self.app.get('/tenders/{}/complaints/{}/documents/{}?download=some_id'.format(self.tender_id,
                                                                                                 self.complaint_id,
                                                                                                 doc_id),
                                status=404)
        self.assertEqual(response.status, '404 Not Found')
        ...
        response = self.app.get('/tenders/{}/complaints/{}/documents/{}?{}'.format(self.tender_id,
                                                                                   self.complaint_id,
                                                                                   doc_id, key))
        self.assertEqual(response.status, '200 OK')
    ...
    def test_put_tender_complaint_document(self):
        ...
        response = self.app.patch_json('/tenders/{}/complaints/{}?acc_token={}'.format(self.tender_id, self.complaint_id,
                                                                                       self.complaint_owner_token),
                                       {"data": {"status": "pending"}})
        self.assertEqual(response.status, '200 OK')
        self.assertEqual(response.json['data']["status"], "pending")
...
class TenderStage2UAComplaintDocumentResourceTest(BaseCompetitiveDialogUAStage2ContentWebTest):
    ...
    def test_not_found(self):
        ...
        response = self.app.post('/tenders/{}/complaints/some_id/documents'.format(self.tender_id),
                                 upload_files=[('file', 'name.doc', 'content')],
                                 status=404)
        self.assertEqual(response.status, '404 Not Found')
        self.assertEqual(response.content_type, 'application/json')
        ...
        response = self.app.get('/tenders/{}/complaints/{}/documents/some_id'.format(self.tender_id, self.complaint_id),
                                status=404)
        self.assertEqual(response.status, '404 Not Found')
        self.assertEqual(response.content_type, 'application/json')
        self.assertEqual(response.json['status'], 'error')
        ...
        response = self.app.put('/tenders/{}/complaints/{}/documents/some_id'.format(self.tender_id, self.complaint_id),
                                upload_files=[('file', 'name.doc', 'content2')],
                                status=404)
        self.assertEqual(response.status, '404 Not Found')
        self.assertEqual(response.content_type, 'application/json')
